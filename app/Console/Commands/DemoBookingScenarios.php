...
class DemoBookingScenarios extends Command
{
    ...
    private function showScenarios(): int
    {
        ...
        $scenarios = [
            1 => '💈 Парикмахерская - Фиксированные слоты + автоматическое подтверждение (усложненный)',
    ...
    private function getScenariosToRun(): array
    {
        ...
        $choice = $this->choice(
            ...
            [
                1 => '1. Парикмахерская (авто-подтверждение, усложненный)',
    ...
    private function runScenario1(array $setupData): void
    {
        ...
        $this->info("\n💈 СЦЕНАРИЙ 1: Парикмахерская (усложненный)");
        $this->line("Параметры: авто-подтверждение, фиксированные слоты 60 мин, перерыв 13:15-14:15");
        $this->line("Тестирование: пограничные случаи с перерывами, валидация пересечений");

        BookingLoggerService::info("Начало Сценария 1: Парикмахерская (усложненный)");
